...
In parallel, watching movies and series is a common activity and enjoyable; streaming platforms have become a popular source of entertainment as noted using the dates from Figure-\ref{fig:netflix_quarter}, Figure-\ref{fig:disney_quarter} and Figure-\ref{fig:subscribers_table}. A huge number of people use those platforms to train or learn a new language using subtitles and audio. \\
